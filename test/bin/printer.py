...
def __doc__():
    return("printer:这是打印文档的核心函数，需要传入打印文件夹的路径作为参数printer:调用相关文档程序失败，请"
           "将福昕阅读器作为打开PDF的默认程序，并保证您的计算机的默认打印机不是类似于pdf打印机的这种文件打印机"
           "")
...
print(os.getcwd())
print_files('C:/printer/received/18796282979/96824522')
# '''
